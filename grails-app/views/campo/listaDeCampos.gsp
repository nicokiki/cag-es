...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US"> 
	...
	<head>
		...
		<title>Click &amp; Golf | <g:message code="campos.todos.title" /></title>
	...
	<body>
		...
		<section class="container layout">
			...
			<section class="page_title">
				<div class="title"><g:message code="campos.todos.title" /></div>
				<div class="slogan"><g:message code="campos.todos.description" default="Todos los campos"/></div>
			</section>
