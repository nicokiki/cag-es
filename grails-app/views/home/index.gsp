								...
								<g:each in="${promocionesSilver}" status="i" var="promocion">
									<div class="grid_3">
										<div class="img_pf_hover">
											<g:if test="${promocion?.esBanner}">
												<img class="img212x142" src="${wthr.staticResource(id:"banner",nombre:"${promocion.imgBanner}")}" alt="${promocion.imgBanner}" title="${promocion.tituloBanner}" />
												<a 	id="a_banner_${promocion.id}"
													href="${wthr.staticResource(id:"banner",nombre:"${promocion.imgGrandeBanner}")}" >
													<span class="img_pf_icon goto_link"></span>
												</a>
												<g:javascript>
												 	$('#a_banner_${promocion.id}').lightbox({
	               										title:'<a href="${fieldValue(bean: promocion, field: "linkBanner")}" target="_blank"><h4 class="h4Center">${promocion.tituloBanner}</h4></a><div class="clear"></div><p class="pTextGold">${promocion["${textoProperty}"]}</p>',
													});
												</g:javascript>
											</g:if>
											<g:else>
