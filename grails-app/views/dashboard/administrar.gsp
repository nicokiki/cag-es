	...
	<body>
		...
		<section class="container layout">
			...
			<section class="grid_8">
				<h3 class="margin_top_0"><g:message code="campos.dashboard.administer.greenFees"/></h3> 
			
				<div id="grid">
   					<g:render template="greenFeesAdmin" model="model" />
  				</div>
  				<div class="clear"></div> 
  				
				<div>
					<div class="block_content">
						<g:link action="nuevo" controller="dashboard" class="button grey textcenter"><g:message code="com.clickandgolf.Campo.nuevo" default="Nuevo" /></g:link>
					</div>
				</div>             				
			</section>
