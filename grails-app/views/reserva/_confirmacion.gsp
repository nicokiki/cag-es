...
<div class="adress_info greenFeeReservadoVer" style="min-width: 400px;">
	<h4><g:message code="greenfee.book.success.descripcion"/></h4>
	<div class="clear"></div>
	...
	<ul class="list14 greenFeeReservadoVer_ul">
		<li>
	...
	<ul class="list18 greenFeeReservadoVer_ul">
		<li>
			<span class="greenFeeReservadoVerTitulo"><g:message code="greenfee.book.fee.pagado"/>:</span>
	...
	<ul class="list18 greenFeeReservadoVer_ul">
		<li>
			...
			&nbsp;<g:formatNumber number="${fieldValue(bean: greenFeeReservado, field: "precioPorPagar")}" format="#0.00" /> &euro;
		</li>
	</ul> 
	<ul class="list9 greenFeeReservadoVer_ul">
		<li>
			...
			&nbsp;<span class="input_tips"><g:message code="greenfee.book.payment.transaction.id.no.pierda"/></span>
		</li>
	</ul> 
	<hr />
	
	<span class="input_tips">
		<strong><g:message code="greenfee.book.success.30.minutos" /></strong>
	</span>
	
	<%-- Esto solo iria en castellano --%>
	<g:if test='${greenFee.campo.notasReserva}'>
		<span class="input_tips">
			${greenFee.campo.notasReserva}
		</span>
	</g:if>	
	...
	<g:if test='${greenFee.campo.requiereLicencia}'>
		<div class="alert exclamation_msg">
			<strong>
				<g:message code="greenfee.book.licencia.necesaria" />
			</strong>
		</div>
	</g:if>
